        ...
        <div className="container pb-8 sm:pb-0">
          <div className="grid grid-cols-1 sm:grid-cols-2">
            ...
            >
              ...
              <p className="text-sm ">
              Savor exquisite flavors in our city oasis. Expertly crafted dishes, inviting ambiance, and attentive service ensure a memorable dining experience with us.
              </p>
              <div>
